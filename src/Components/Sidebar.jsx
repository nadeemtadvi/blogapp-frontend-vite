...
const Sidebar = () => {
  return (
    <div className="">
      ...
      <aside
        id="default-sidebar"
        className=" top-0 left-0 z-40 w-56 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Addpost</span>
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">All Post</span>
              </Link>
            </li>
