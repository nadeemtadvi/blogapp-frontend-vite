...
const Footer = () => {
  ...
  <div className="">
    ...
    <div className="p-1.5 sm:p-3 flex justify-between items-center">
      <h4 className="text-[0.65rem] sm:text-[18px] text-subtext">@ 2024 All Rights Reserved</h4>
      <h4 className="text-[0.65rem] sm:text-[18px] text-subtext">Designed by Nadeem</h4>
